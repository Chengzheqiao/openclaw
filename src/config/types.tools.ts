...
export type ToolsConfig = {
  ...
  web?: {
    search?: {
      ...
      enabled?: boolean;
      /** Search provider ("serper", "brave", "perplexity", "grok", "gemini", or "kimi"). */
      provider?: "serper" | "brave" | "perplexity" | "grok" | "gemini" | "kimi";
      ...
      /** Serper (Google Search) configuration (used when provider="serper"). */
      serper?: {
