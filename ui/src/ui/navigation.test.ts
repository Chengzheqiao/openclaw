...
describe("TAB_GROUPS", () => {
  it("contains all expected groups", () => {
    ...
    expect(labelKeys).toContain("tabGroupChat");
    expect(labelKeys).toContain("tabGroupControl");
    expect(labelKeys).toContain("tabGroupAgent");
    expect(labelKeys).toContain("tabGroupSettings");
  });
